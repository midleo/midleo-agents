...
MQSC
  ...
  * )
      ...
      echo "   -  $0 enableavl WEBLOGIC_HOST weblogic '{\"conntype\":\"rest\",\"user\":\"USERNAME_FOR_WEBLOGIC_REST\",\"pass\":\"PASSWORD_FOR_WEBLOGIC_REST\",\"ssl\":\"yes\",\"sslverify\":\"yes|no\",\"mngmport\":\"9002\",\"appserver\":\"AdminServer\",\"appsrvid\":\"MIDLEO_SERVER_ID\"}'"
      ...
      echo "   -  $0 addappstat SRV_TYPE APPSRV '{\"queues\":\"TEST.*,VVV.*\",\"channels\":\"SDR.*,CHL.*\",\"sslverify\":\"yes|no\"}'"
      echo "   -  $0 delappstat SRV_TYPE APPSRV"
      echo "   -  $0 addoptadvisor SRV_TYPE APPSRV '{\"appsrvid\":\"MIDLEO_SERVER_ID\",\"usr\":\"USER\",\"pass\":\"PASS\",\"ssl\":\"yes\",\"sslverify\":\"yes|no\",\"mngmport\":\"7001\"}'"
